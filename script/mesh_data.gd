...
@onready var materials = [
	...
	preload("res://asset/mat/wood_bbh_wall.tres"), # Material 086
	preload("res://asset/mat/wood_bbh_floor.tres"), # Material 087
...
func build_tile_array() -> Array[Tile]:
	...
	Tile.new([
		...
		TileSide.new(shift(TRI_SLOPER_BACK,2,1),INDICE_TRI_FLIPPED,  	BACK, 		Cull.Tri_1, Dir.Back, 	GrowthTypes.SlopeSideL,	UV_TRI),
		TileSide.new(PLANE_DOWN,				INDICE_QUAD_FLIPPED,	DOWN, 		Cull.Full, 	Dir.Bottom,	GrowthTypes.None,		UV_QUAD_TOP),
	...
	Tile.new([
		...
		TileSide.new(flip_y(shift(TRI_SLOPER_BACK,2,1)),INDICE_TRI,  		BACK, 		Cull.DownTri_1,	Dir.Front, 	GrowthTypes.SlopeSideL,		UV_TRI),
		TileSide.new(PLANE_UP,							INDICE_QUAD,		UP, 		Cull.Full, 		Dir.Top, 	GrowthTypes.None,			UV_QUAD_TOP),
		TileSide.new(PLANE_RIGHT,						INDICE_QUAD,		RIGHT, 		Cull.Full, 		Dir.Left, 	GrowthTypes.NormalSide,		UV_QUAD_INVERSE),
